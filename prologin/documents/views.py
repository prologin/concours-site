...
def generate_convocations(request):
	...
	with open('prologin/documents/contestants.tex', 'w') as f:
	...
	os.system('pwd')
	os.system('cd prologin/documents && pdflatex convocations-epreuves-regionales')
	response = HttpResponse(FileWrapper(open('prologin/documents/convocations-epreuves-regionales.pdf')), mimetype='application/pdf')
