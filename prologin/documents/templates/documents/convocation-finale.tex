...
programmation se fera obligatoirement en C, C++, Java, Python, PHP, C\#, Haskell ou OCaml.
Nous vous demandons de bien vouloir vous munir d'\textbf{une pièce d'identité
