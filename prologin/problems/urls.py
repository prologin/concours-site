...
urlpatterns = [
    url(r'^challenge/(?P<type>demi|qcm)(?P<year>[0-9]{4})$',
        problems.views.LegacyChallengeRedirect.as_view(),
        name='legacy-challenge'),

    url(r'^challenge/(?P<type>demi|qcm)(?P<year>[0-9]{4})/(?P<problem>[a-zA-Z0-9_-]+)$',
        problems.views.LegacyProblemRedirect.as_view(),
        name='legacy-problem'),
