...
urlpatterns = [
    ...
    url(r'^(?P<year>[0-9]{4})/(?P<type>[a-z\-]+)/(?P<problem>[a-zA-Z0-9_-]+)/(?P<submission>[0-9]+)$', problems.views.Submission.as_view(), name='submission'),

    url(r'^submission-corrected/(?P<submission>[0-9]+)$', problems.views.AjaxSubmissionCorrected.as_view(), name='ajax-submission-corrected'),
