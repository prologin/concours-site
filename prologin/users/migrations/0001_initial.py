    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'}, max_length=30, unique=True, validators=[django.core.validators.RegexValidator('^[\\w.@+-]+$', 'Enter a valid username. This value may contain only letters, numbers and @/./+/-/_ characters.', 'invalid')], verbose_name='username', help_text='Required. 30 characters or fewer. Letters, digits and @/./+/-/_ only.')),
                ...
                ('preferred_locale', models.CharField(blank=True, max_length=8, verbose_name='Locale')),
                ('avatar', models.ImageField(blank=True, verbose_name='Profile picture', upload_to=upload_path('avatar'))),
                ('picture', models.ImageField(blank=True, verbose_name='Official member picture', upload_to=upload_path('picture'))),
