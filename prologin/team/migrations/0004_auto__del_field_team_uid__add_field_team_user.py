...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Team.uid'
        raise RuntimeError("Cannot reverse this migration. 'Team.uid' and its values cannot be restored.")
        # Deleting field 'Team.user'
        db.delete_column('team_team', 'user_id')
