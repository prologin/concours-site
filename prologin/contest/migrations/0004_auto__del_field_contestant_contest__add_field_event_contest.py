...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contestant.contest'
        db.delete_column('contest_contestant', 'contest_id')

        # Adding field 'Event.contest'
        db.add_column('contest_event', 'contest',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['contest.Contest']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Contestant.contest'
        raise RuntimeError("Cannot reverse this migration. 'Contestant.contest' and its values cannot be restored.")
        # Deleting field 'Event.contest'
        db.delete_column('contest_event', 'contest_id')
