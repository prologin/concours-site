...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Event.contest'
        raise RuntimeError("Cannot reverse this migration. 'Event.contest' and its values cannot be restored.")
