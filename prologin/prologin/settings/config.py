...
RECAPTCHA_PUBLIC_KEY = 'changeMeIfYouWantPublic'
RECAPTCHA_PRIVATE_KEY = 'changeMeIfYouWantPrivate'
...
PROLOGIN_CONTACT_MAIL = 'info@bfor.ovh'
...
TRAINING_PROBLEM_REPOSITORY_PATH = '/var/www/prologin/problems'
